    ...
    return (
        <>
            <div className="bg-blue-500">
                <nav className="relative px-4 py-4 flex justify-between items-center bg-white">
                    ...
                    <Image
                                                    className='ml-4 rounded-full object-cover  h-12 w-16'
                                                    src={logo}
                                                />
                      
                    </a>
                    <div class="md:hidden">
                        <button class="navbar-burger flex items-center text-blue-600 p-3" onClick={toggleMenu}>
                    ...
                    <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 
        md:flex md:mx-auto md:flex md:items-center md:w-auto md:space-x-6">
                    ...
                    <button
                        ...
                        class="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-200 hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-xl transition duration-200"
                        href="#">Logout</button>
                </nav>
                            ...
                            <ul>
                                ...
                                <li class="mb-1">
                                    <button
                                        ...
                                        class="block px-4 py-2 mb-3 
                                        leading-loose text-xs text-center font-semibold leading-none bg-gray-200 hover:bg-gray-100 rounded-md"
                                        href="#">
                                        Logout
                                    </button>
                                </li>
