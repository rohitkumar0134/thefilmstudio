...
">
    ...
    <div class="relative py-3 sm:max-w-xl sm:mx-auto">
        <div
            class="absolute inset-0 bg-gradient-to-r from-white to-stone-300 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl">
        </div>
        <div class="text-white relative px-4 py-10 bg-gray-400 shadow-lg sm:rounded-3xl sm:p-20">
            ...
            <form>
                ...
                <textarea
                        ...
                        type="text" placeholder="Type your message here..." name="message" style={{"height": "121 em"}}></textarea>

                <div class="flex justify-between">
                    <input
                        class="shadow bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
...
{/* 
      <div class="  mapcontainer container my-24 mx-auto md:px-6">
  <section class="mb-32">
    <div
